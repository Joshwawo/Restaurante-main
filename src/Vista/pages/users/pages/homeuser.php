...
$ejecutaConsulta = $conn->query($consulta);
$row = $ejecutaConsulta->fetch_assoc();
    ...
    <main>
        ...
        <div class="container">
            <nav class="heading__mio">
                ...
                <a class="heading__mio" id="lg" href="../../../../Controlador/sesion/Cerrar.php">Cerrar Sesion</a>
            </nav>
            <header class="headermio">
                <h1 class="headermio--h1">Bienvenido de Nuevo <?php $ejecutaConsulta;?></h1>
